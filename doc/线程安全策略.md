...
示例代码：[VectorExample1.java](../src/main/java/com/mmall/concurrency/example/syncContainer/VectorExample1.java)
...
示例代码：[VectorExample2.java](../src/main/java/com/mmall/concurrency/example/syncContainer/VectorExample2.java)
...
解决办法：如果使用foreach或iterator遍历时，不要在操作过程中不要进行remove，如果一定要进行的话建议在遍历过程中做好标记，在遍历完后再进行remove，也可以使用for循环进行遍历删除

### （2）HashMap的线程安全类：HashTable

使用举例:

示例代码：[HashTableExample.java](../src/main/java/com/mmall/concurrency/example/syncContainer/HashTableExample.java)
...
示例代码：[CollectionsExample1.java](../src/main/java/com/mmall/concurrency/example/syncContainer/CollectionsExample1.java)、[CollectionsExample2.java](../src/main/java/com/mmall/concurrency/example/syncContainer/CollectionsExample2.java)、[CollectionsExample3.java](../src/main/java/com/mmall/concurrency/example/syncContainer/CollectionsExample3.java)
